...
|Days above 90th percentile|TX90P|annual|[ETCCDI Climate Change Indices](http://etccdi.pacificclimate.org/list_27_indices.shtml)|:yellow_circle:<br>:yellow_circle:|:yellow_circle:<br>:yellow_circle:|:yellow_circle:<br>:yellow_circle:|:yellow_circle:<br>:yellow_circle:|:yellow_circle:<br>:yellow_circle:||Data in process of being moved ont project ia39|20/06/2024
